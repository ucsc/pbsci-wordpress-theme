...
?>
    ...
    <div id="primary" class="content-area">
        ...
        while ( have_posts() ) :
            ...
            } else if ("Student Support" == get_the_title()||"Student Research Opportunities" == get_the_title()||"Institutes and Centers" == get_the_title()||"Researcher and Faculty Labs" == get_the_title()) {
